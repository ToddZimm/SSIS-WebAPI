...
//     Last Modified On: 6/3/2023 8:12:59 PM
...
namespace SSIS.DataService.SQLAgent.Models
{
    ...
    public partial class JobStepsResult
	{
        ...
        public JobStepsResult(Guid? StepId, string Name, Guid JobId, string JobName, int StepSequenceId, string Subsystem, long? SSISPackageId, string SSISPackagePath, string Command, string DatabaseName, string DatabaseUserName, string ProxyName, DateTime? LastRunAt, string LastOutcome, string OnSuccessAction, string OnFailAction, int RetryAttempts, int RetryIntervalMinutes)
        {
             this.StepId = StepId;
             this.Name = Name;
             this.JobId = JobId;
