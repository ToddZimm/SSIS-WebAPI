...
namespace SSIS.DataService.SSISDB
{
    ...
    public partial class Service
    {
        ...
        private SqlCommand Projects_BuildCommand(SqlConnection cnn, ProjectsInput input)
        {
...
SET @Count = @@ROWCOUNT;",
            ...
            {
                result.Parameters["@FolderId"].Value = input.FolderId;
            }
            return result;
        }
        ...
        /// </summary>
        /// <param name="input">ProjectsInput instance.</param>
        /// <returns>Instance of ProjectsOutput</returns>
        public ProjectsOutput Projects(ProjectsInput input)
        {
            ValidateInput(input, nameof(Projects));
            ProjectsOutput output = new ProjectsOutput();
			if(sqlConnection != null)
            {
                using (SqlCommand cmd = Projects_BuildCommand(sqlConnection, input))
                {
            ...
            for(int idx=0; idx <= retryOptions.RetryIntervals.Count; idx++)
            {
                ...
                try
                {
                    ...
                    using (SqlCommand cmd = Projects_BuildCommand(cnn, input))
                    {
                        cnn.Open();
						Projects_Execute(cmd, output);
                        cnn.Close();
