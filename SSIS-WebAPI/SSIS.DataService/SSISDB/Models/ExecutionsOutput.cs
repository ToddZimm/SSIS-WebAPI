...
namespace SSIS.DataService.SSISDB.Models
{
    ...
    public partial class ExecutionsResult
	{
        ...
        public ExecutionsResult(long ExecutionId, long PackageId, string FolderName, string ProjectName, string PackageName, int StatusId, string StatusName, string FirstErrorMessage, DateTimeOffset? CreatedAt, DateTimeOffset? StartedAt, DateTimeOffset? EndedAt, string EnvironmentFolder, string EnvironmentName, string CalledBy, string ExecutedAs, string StoppedBy, bool Use32BitRuntime, int? DurationSeconds, string DurationDisplay, string ServerName)
        {
