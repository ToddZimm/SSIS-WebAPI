...
namespace SSIS.DataService.SSISDB.Models
{
    ...
    public partial class UnresolvedExecutionErrorsResult
	{
        ...
        public UnresolvedExecutionErrorsResult(long ExecutionId, long PackageId, string FolderName, string ProjectName, string PackageName, int Status, string? StatusName, string? FirstErrorMessage, DateTimeOffset? CreatedTime, DateTimeOffset? StartTime, DateTimeOffset? EndTime, string? EnvironmentFolder, string? EnvironmentName, string Caller, string ExecutedAs, string? StoppedBy, bool Use32BitRuntime, int? DurationSeconds, string? DurationDisplay)
        {
