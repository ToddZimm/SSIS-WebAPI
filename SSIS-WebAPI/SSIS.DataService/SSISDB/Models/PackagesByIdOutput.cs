...
namespace SSIS.DataService.SSISDB.Models
{
    ...
    public partial class PackagesByIdResult
	{
        ...
        public PackagesByIdResult(long PackageId, string PackageName, string? Description, string? ProjectName, string? FolderName, int PackageFormatVersion, string ValidationStatus, DateTimeOffset? LastValidationTime, Guid PackageGuid, Guid VersionGuid, int VersionMajor, int VersionMinor, int VersionBuild, string? VersionComments)
        {
